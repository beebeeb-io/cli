...
## Summary
- 909 nodes · 2400 edges · 23 communities detected
- Extraction: 72% EXTRACTED · 28% INFERRED · 0% AMBIGUOUS · INFERRED: 675 edges (avg confidence: 0.8)
...
Cohesion: 0.04
Nodes (105): invoices(), open_invoice_pdf(), portal(), purchase_addon(), show(), usage(), run(), browser_login() (+97 more)

### Community 1 - "Community 1"
Cohesion: 0.05
Nodes (107): capitalise(), format_number(), write_private_temp_pdf_refuses_to_follow_an_existing_symlink_at_the_target_path(), Match, Node, walk_mem(), walk_mem_anchored_subtree_only(), walk_mem_dfs_order_paths_and_walked() (+99 more)
...
Cohesion: 0.06
Nodes (27): addons(), aggregate_by_region(), aggregate_by_region_defaults_missing_storage_location_to_europe_falkenstein(), aggregate_by_region_empty_input_is_empty_output(), aggregate_by_region_splits_multiple_regions(), aggregate_by_region_sums_bytes_per_region_and_skips_folders(), format_date_human(), format_invoice_amount() (+19 more)

### Community 8 - "Community 8"
Cohesion: 0.08
Nodes (31): b64(), check_quota(), collect_entries(), ConflictResolution, ConflictStrategy, dir_total_size(), find_conflict(), prompt_conflict() (+23 more)
...
Cohesion: 0.11
Nodes (32): diagnose_unauthorized(), diagnose_unauthorized_blames_the_code_when_the_session_is_alive(), diagnose_unauthorized_blames_the_session_when_it_is_dead(), spawn_me_mock(), backoff(), build_client(), delete_passkey_sends_delete_to_the_id_path_with_bearer_auth_and_no_confirm_token(), download_invoice_pdf_returns_the_raw_bytes() (+24 more)
...
- **Thin community `Community 21`** (6 nodes): `build_plan_label()`, `capitalise()`, `upload_limit_for_plan()`, `upload_limit_for_plan_covers_every_plan()`, `upload_limit_for_starter_matches_basic()`, `whoami.rs`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `is_quiet()` connect `Community 0` to `Community 1`, `Community 2`, `Community 3`, `Community 5`, `Community 8`, `Community 9`, `Community 12`, `Community 13`, `Community 16`, `Community 22`?**
  _High betweenness centrality (0.095) - this node is a cross-community bridge._
- **Why does `ApiClient` connect `Community 2` to `Community 0`, `Community 1`, `Community 11`?**
  _High betweenness centrality (0.087) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 0` to `Community 3`, `Community 4`, `Community 7`, `Community 8`, `Community 10`, `Community 13`, `Community 14`, `Community 16`?**
...
- **Are the 15 inferred relationships involving `run()` (e.g. with `is_rich()` and `is_json()`) actually correct?**
