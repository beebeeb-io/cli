# Graph Report - cli-44-lead  (2026-09-26)

## Corpus Check
- 63 files · ~109,857 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1014 nodes · 2692 edges · 24 communities detected
- Extraction: 72% EXTRACTED · 28% INFERRED · 0% AMBIGUOUS · INFERRED: 741 edges (avg confidence: 0.8)
...
Cohesion: 0.04
Nodes (101): show(), invoices(), open_invoice_pdf(), portal(), purchase_addon(), usage(), run(), run() (+93 more)

### Community 1 - "Community 1"
Cohesion: 0.06
Nodes (88): write_private_temp_pdf_refuses_to_follow_an_existing_symlink_at_the_target_path(), b64(), classify_new_local_is_not_a_delete(), classify_prior_synced_modified_is_readd(), classify_prior_synced_unchanged_is_remote_delete(), classify_remote_absent(), compute_file_hash(), create_folder() (+80 more)
...
Cohesion: 0.09
Nodes (43): Match, Node, print_results(), run(), walk_mem(), walk_mem_anchored_subtree_only(), walk_mem_dfs_order_paths_and_walked(), walk_mem_stops_at_limit() (+35 more)

### Community 10 - "Community 10"
Cohesion: 0.07
Nodes (37): browser_login(), print_browser_block(), print_headless_block(), run(), spawn_countdown(), oneRun(), String, clear_config() (+29 more)

### Community 11 - "Community 11"
Cohesion: 0.09
Nodes (40): b64std(), b64url(), build_link(), create(), decode_any_b64(), generate_request_keypair(), keypair_wrap_unwrap_roundtrip_matches_create_then_list(), link_assembly_roundtrips_through_parse() (+32 more)
...
## Knowledge Gaps
- **65 isolated node(s):** `Mock`, `ThumbnailResult`, `Invocation`, `OutputMode`, `DeviceInfo` (+60 more)
  These have ≤1 connection - possible missing edges or undocumented components.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `is_quiet()` connect `Community 0` to `Community 1`, `Community 2`, `Community 7`, `Community 9`, `Community 11`, `Community 13`, `Community 16`, `Community 21`?**
  _High betweenness centrality (0.085) - this node is a cross-community bridge._
- **Why does `run()` connect `Community 1` to `Community 0`, `Community 4`, `Community 9`, `Community 10`, `Community 13`?**
...
- **What connects `Mock`, `ThumbnailResult`, `Invocation` to the rest of the system?**
