# Graph Report - cli-flow1-7  (2026-09-25)

## Corpus Check
- 59 files · ~104,452 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 946 nodes · 2510 edges · 22 communities detected
- Extraction: 71% EXTRACTED · 29% INFERRED · 0% AMBIGUOUS · INFERRED: 717 edges (avg confidence: 0.8)
...
Cohesion: 0.06
Nodes (94): capitalise(), format_number(), write_private_temp_pdf_refuses_to_follow_an_existing_symlink_at_the_target_path(), collect_all_files(), encrypt_chunks_with_string_key(), Match, Node, print_results() (+86 more)

### Community 2 - "Community 2"
Cohesion: 0.05
Nodes (81): build_show_payload(), build_show_payload_assembles_all_sections(), build_show_payload_degrades_gracefully_per_section(), map_email_change_error(), normalize_update_email(), opaque_email_change(), print_email_change_success(), render_progress_bar() (+73 more)
...
Cohesion: 0.05
Nodes (47): AccountCmd, AddonsAction, BillingAction, build_help_text(), Cli, Commands, help_footer_links_are_the_known_set(), help_links() (+39 more)
...
Cohesion: 0.08
Nodes (35): run(), browser_login(), print_browser_block(), print_headless_block(), run(), spawn_countdown(), run(), passkey_enrollment_url() (+27 more)
...
Cohesion: 0.32
Nodes (5): acquire_confirm_token(), acquire_confirmed_password(), confirm_password_session_too_old_survives_a_message_that_does_not_mention_the_code(), ConfirmedPassword, map_confirm_error()
...
- **Why does `is_quiet()` connect `Community 2` to `Community 0`, `Community 1`, `Community 7`, `Community 10`, `Community 12`, `Community 15`, `Community 18`?**
  _High betweenness centrality (0.092) - this node is a cross-community bridge._
- **Why does `ApiClient` connect `Community 0` to `Community 2`?**
  _High betweenness centrality (0.084) - this node is a cross-community bridge._
- **Why does `is_json()` connect `Community 2` to `Community 1`, `Community 7`, `Community 9`, `Community 10`, `Community 12`, `Community 15`, `Community 18`?**
