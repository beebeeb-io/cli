# Graph Report - cli-cap0  (2026-09-25)

## Corpus Check
- 62 files · ~108,205 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 999 nodes · 2649 edges · 21 communities detected
- Extraction: 72% EXTRACTED · 28% INFERRED · 0% AMBIGUOUS · INFERRED: 732 edges (avg confidence: 0.8)
...
- `browser_login()` --calls--> `text()`  [INFERRED]
  src/commands/login.rs → tests/auth_errors.rs
...
Cohesion: 0.05
Nodes (111): capitalise(), format_number(), purchase_addon(), write_private_temp_pdf_refuses_to_follow_an_existing_symlink_at_the_target_path(), dir_total_size(), prompt_conflict(), Match, Node (+103 more)
...
Cohesion: 0.05
Nodes (51): AccountCmd, AddonsAction, all_help_text(), BillingAction, build_help_text(), Cli, Commands, help_footer_text() (+43 more)
...
## Knowledge Gaps
- **64 isolated node(s):** `ThumbnailResult`, `Invocation`, `OutputMode`, `DeviceInfo`, `DownloadStats` (+59 more)
  These have ≤1 connection - possible missing edges or undocumented components.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `is_quiet()` connect `Community 2` to `Community 0`, `Community 1`, `Community 3`, `Community 4`, `Community 5`, `Community 7`, `Community 10`, `Community 12`, `Community 13`, `Community 14`?**
  _High betweenness centrality (0.085) - this node is a cross-community bridge._
- **Why does `ApiClient` connect `Community 1` to `Community 0`, `Community 10`?**
  _High betweenness centrality (0.079) - this node is a cross-community bridge._
- **Why does `is_json()` connect `Community 2` to `Community 0`, `Community 3`, `Community 4`, `Community 5`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 12`, `Community 13`, `Community 14`?**
