...
## Corpus Check
- 59 files · ~91,111 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 839 nodes · 2240 edges · 21 communities detected
...
Cohesion: 0.06
Nodes (101): format_number(), dir_total_size(), prompt_conflict(), Match, Node, print_results(), run(), walk_mem() (+93 more)
...
Cohesion: 0.07
Nodes (31): add_json_body_carries_the_url_and_a_note_never_a_token(), AddAction, classify_list_error(), enrollment_url_for_local_api_points_at_the_local_dev_web_app(), enrollment_url_for_prod_api_points_at_the_prod_web_app(), enrollment_url_for_unrecognized_host_stays_on_that_hosts_origin(), enrollment_url_generalizes_beyond_the_literal_beebeeb_io_host(), enrollment_url_handles_http_scheme_api_host_too() (+23 more)
...
Cohesion: 0.12
Nodes (33): decrypt_name(), collect_zip_entries(), looks_like_id_prefix(), pull_folder(), pull_folder_inner(), pull_single_file(), resolve_as_path(), resolve_request_key() (+25 more)
...
- **Why does `is_quiet()` connect `Community 1` to `Community 0`, `Community 2`, `Community 4`, `Community 8`, `Community 11`, `Community 14`, `Community 16`?**
  _High betweenness centrality (0.095) - this node is a cross-community bridge._
- **Why does `ApiClient` connect `Community 2` to `Community 0`, `Community 1`?**
  _High betweenness centrality (0.092) - this node is a cross-community bridge._
- **Why does `run()` connect `Community 0` to `Community 1`, `Community 3`, `Community 8`, `Community 10`, `Community 20`?**
