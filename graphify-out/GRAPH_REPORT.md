# Graph Report - cli-rc37  (2026-09-25)

## Corpus Check
- 62 files · ~107,581 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 985 nodes · 2612 edges · 21 communities detected
...
Cohesion: 0.05
Nodes (88): decrypt_listing(), DecryptedFile, LsOpts, print_header(), print_json(), print_recursive(), print_row(), run() (+80 more)
...
Cohesion: 0.04
Nodes (57): addons(), aggregate_by_region(), aggregate_by_region_defaults_missing_storage_location_to_europe_falkenstein(), aggregate_by_region_empty_input_is_empty_output(), aggregate_by_region_splits_multiple_regions(), aggregate_by_region_sums_bytes_per_region_and_skips_folders(), capitalise(), format_date_human() (+49 more)

### Community 4 - "Community 4"
Cohesion: 0.04
Nodes (56): AccountCmd, AddonsAction, all_help_text(), BillingAction, build_help_text(), Cli, Commands, help_footer_text() (+48 more)
...
Cohesion: 0.07
Nodes (48): acquire_confirm_token(), acquire_confirmed_password(), confirm_password_session_too_old_survives_a_message_that_does_not_mention_the_code(), ConfirmedPassword, map_confirm_error(), Match, Node, walk_mem() (+40 more)
...
Cohesion: 0.09
Nodes (29): run(), oneRun(), String, Config, combined(), dist_builds_with_fuse(), help_does_not_list_mount_in_a_build_without_fuse(), mount_stub_points_at_webdav_not_a_nonexistent_fuse_build() (+21 more)
...
- **Why does `is_quiet()` connect `Community 0` to `Community 1`, `Community 2`, `Community 3`, `Community 5`, `Community 6`, `Community 8`, `Community 10`, `Community 13`, `Community 18`?**
  _High betweenness centrality (0.086) - this node is a cross-community bridge._
- **Why does `ApiClient` connect `Community 2` to `Community 10`, `Community 7`?**
  _High betweenness centrality (0.080) - this node is a cross-community bridge._
- **Why does `is_json()` connect `Community 0` to `Community 1`, `Community 3`, `Community 5`, `Community 6`, `Community 8`, `Community 9`, `Community 10`, `Community 11`, `Community 13`, `Community 18`?**
